    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Vibrates Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:0, paddingHorizontal:20}}>
              ...
              <View style={[Styles.testIconBox]}>
                ...
                <Image source={require('../../assets/images/test/test17.png')} style={[Styles.testImage,{width:'75%', borderRadius:20}]} />

                <Text style={[Styles.testTextCenter]}>
                  Vibrates the devices
                </Text>

                <Text style={[Styles.testTextCenter]}>
                  Please check if the device is vibrating or not
                </Text>

               <Text style={[Styles.testTextCenter,{marginBottom:0,paddingBottom:30}]}>
                  Is it working?
                </Text>
