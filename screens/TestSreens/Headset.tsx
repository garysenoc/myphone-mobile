    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Headset Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:0}}>


              <View style={[Styles.testIconBox]}>

              <Image source={require('../../assets/images/test/test14.png')} style={[Styles.testImage,{width:'70%'}]} />

                <Text style={[Styles.testTextCenter]}>
                  Now let's test the device recording from the headphones, and plays the recording
                </Text>
                <Text style={[Styles.testTextCenter,{marginBottom:0,paddingBottom:15}]}>
                    Waiting to detect headset...
                </Text>
