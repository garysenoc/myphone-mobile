        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:10, paddingHorizontal:0}}>
              ...
              <View style={[Styles.testIconBox]}>
                ...
                <Image source={require('../../assets/images/test/test15.png')} style={[Styles.testImage,{width:'70%'}]} />

                <Text style={[Styles.testTextCenter,{paddingBottom:0,marginBottom:0}]}>
                  Check to make sure the front and rear cameras work correctly
                </Text>
                <Text style={[Styles.testTextCenter]}>
                  After taking a photo with each camera, please confirm if the photo is satisfactory.
                </Text>
              ...
              <View style={{width:'100%', display:'flex',paddingBottom:30,justifyContent:'center', flexDirection:'row', flexWrap:'wrap'}}>
                      ...
                      <TouchableOpacity
                        activeOpacity={.7}
                        onPress={()=>navigation.navigate('CameraPicture')}
                        style={[Styles.testFooterBtn,{marginHorizontal:5}]}
                      >
