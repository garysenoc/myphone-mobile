    ...
    <SafeAreaView>
        ...
        <View style={Styles.main}>
            <View style={{marginTop:25, marginBottom:10}}>
              <Text style={[Styles.primaryText,{fontSize:20, textAlign:'center'}]}>iPhone Products</Text>
            </View>
            <View style={Styles.productCardList}>
              
              {
                products.map((product,index)=>(
                <TouchableOpacity key={index} style={{width:'23%',}} onPress={()=>navigation.navigate('SellDetails')}>
...
const styles = StyleSheet.create({
  ...
  export default ProductTypeInner;