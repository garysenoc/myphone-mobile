        ...
        <View style={Styles.detailList}>
          <View
            ...
            <Text
              style={[
                Styles.detailTitle,
                {paddingBottom: 5, paddingTop: 0, textTransform: 'lowercase'},
              ]}>
              Hishamhosam20@gmail.com
            </Text>
            <Text
              style={[Styles.detailTitle, {fontSize: 12, paddingVertical: 5}]}>
          ...
          <View
            ...
            <View
              ...
              <Text style={{color: '#D42828', fontSize: 16}}>310.00$</Text>
            </View>
            ...
            <View
              ...
              <Text style={{color: '#D42828', fontSize: 16}}>0.5%</Text>
            </View>
          </View>
        </View>
