        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:20}}>
              ...
              <View style={Styles.testIconBox}>
                ...
                <Image source={require('../../assets/images/test/test1.png')} style={Styles.testImage} />

                <TouchableOpacity style={[Styles.checkButton]} onPress={()=> navigation.navigate('Home')} >
                   <Text style={Styles.mainButtonText}>I have no code</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[Styles.checkButton]} onPress={()=> navigation.navigate('EnterCode')}>
                   <Text style={Styles.mainButtonText}>I have a code from the website</Text>
                </TouchableOpacity>
