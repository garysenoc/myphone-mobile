    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Connectivity Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:30}}>
              ...
              <View style={[Styles.testIconBox]}>
                ...
                *Please grant permission to your location when promoted to allow the go's to complete.
              </Text>
              <Text style={[Styles.testTextCenter]}>
                *Turn on Wifi if off
              </Text>
