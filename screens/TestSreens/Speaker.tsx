    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Speaker Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:0, paddingHorizontal:30}}>

              <View style={[Styles.testIconBox]}>
              
              <Image source={require('../../assets/images/test/test13.png')} style={[Styles.testImage,{width:'75%'}]} />

              <Text style={[Styles.testTextCenter]}>
                Plays the sound from device speaker
              </Text>

              <Text style={[Styles.testTextCenter]}>
                Please check if the sound if playing properly from speaker
              </Text>
