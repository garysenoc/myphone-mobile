    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Proximity Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:0, paddingHorizontal:20}}>
           

              <View style={[Styles.testIconBox, {paddingBottom:0}]}>
                <Image source={require('../../assets/images/test/test4.png')} style={[Styles.testImage,{width:'80%'}]} />
                {/* <AntDesign name='closecircle' color='#E16F6F' size={25} /> */}

              </View>
              <Text style={[Styles.testTextCenter,{paddingBottom:0, marginBottom:0,}]}>
                Put your hand over the front camera
                to check the proximity sensor 
              </Text>

              <Text style={[Styles.testTextCenter,{paddingBottom:0, marginBottom:0,}]}>
                Please place your hand on the device to activate proximity sensor.
              </Text>
            ...
            <View style={{paddingHorizontal:12,display:'flex',  paddingVertical:5, alignItems:'center', justifyContent:'center', width:'100%'}}>
              <View style={{width:'100%', display:'flex',paddingVertical:30,justifyContent:'center', flexDirection:'row', flexWrap:'wrap'}}>
                      ...
                      <TouchableOpacity
                        ...
                        style={[Styles.testFooterBtn,{marginHorizontal:3}]}
                      >
                        <Text style={[Styles.mainButtonText, {textTransform:'lowercase', marginHorizontal:3}]}>Skip</Text>
                      </TouchableOpacity>
                ...
                <TextInput
                      ...
                      multiline = {true}
                      numberOfLines = {4}
                      style={[Styles.regularField,{textAlignVertical:'top', fontSize:14,}]}
                />
              </View>
          ...
          <View style={Styles.testPopupBox}>
            ...
            <View style={{display:'flex', flexDirection:'row',}}>
              ...
              <TouchableOpacity
                    ...
                    style={[Styles.mainButton,{width:120, paddingVertical:10, marginLeft:5, backgroundColor:'#070707'} ]}
                  >
