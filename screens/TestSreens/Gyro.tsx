    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Gyro Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:30}}>
              ...
              <Image source={require('../../assets/images/test/test5.png')} style={[Styles.testImage,{width:'80%'}]} />

                <Text style={[Styles.testTextCenter,{paddingBottom:0, marginBottom:0,}]}>
                  Now let's test the gyroscope, please shake your device
                </Text>
