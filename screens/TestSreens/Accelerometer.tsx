    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Accelerometer Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative'}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:15}}>
              ...
              <View style={[Styles.testIconBox]}>
                <Image source={require('../../assets/images/test/test6.png')} style={[Styles.testImage,{width:'75%'}]} />

                <Text style={[Styles.testTextCenter, {textAlign:'left', width:'100%'}]}>
                  Now let's make sure the device's orientaion sensors works (accelerometer).
                </Text>
              ...
              <View style={[Styles.testTextAlign,{alignItems:'center'}]}>
                ...
                <View style={{width:'10%'}}>
                  <AntDesign name='closecircle' color='#E16F6F' size={20} />
                </View>
              </View>
              ...
              {/* <View style={[Styles.testTextAlign,{alignItems:'center'}]}>
                ...
                <View style={{width:'10%'}}>
                  <AntDesign name='checkcircle' color='#75AC64' size={20} />
                </View>
              </View> */}
