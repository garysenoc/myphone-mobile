    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Touch Response Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:10}}>
              ...
              <View style={[Styles.testIconBox]}>
                ...
                <Image source={require('../../assets/images/test/test11.png')} style={[Styles.testImage,{width:'70%'}]} />
                <Text style={[Styles.testTextCenter,{textAlign:'left', width:'100%'}]}>
                  Now let's test the digitizer to make sure the screen works
                </Text>
                <View style={{width:'100%', display:'flex', flexDirection:'row', alignItems:'flex-start',}}>
                  ...
                  <Text style={[Styles.testTextCenter,{marginBottom:0,textAlign:'left', paddingVertical:0}]}>
                    Swipe or tap each square on the screen so it turns green when touch input is registered
                  </Text>
                </View>
