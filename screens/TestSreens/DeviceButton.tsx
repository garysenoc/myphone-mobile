    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Device Button Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:30}}>
              ...
              <View style={[Styles.testIconBox]}>
                ...
                <Image source={require('../../assets/images/test/test9.png')} style={[Styles.testImage,{width:'75%'}]} />
              <Text style={[Styles.testTextCenter]}>
                Now let's test the button on the device, if it does not work please press the yellow
                triangle to fail that button
              </Text>
              ...
              <View style={[Styles.testTextAlign,{alignItems:'center'}]}>
                ...
                <View style={{width:'10%'}}>
                  <AntDesign name='warning' color='#FBAB55' size={20} />
                </View>
              </View>
