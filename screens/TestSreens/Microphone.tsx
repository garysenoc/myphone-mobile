    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Microphone Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:10}}>
              ...
              <View style={[Styles.testIconBox]}>
                ...
                <Image source={require('../../assets/images/test/test8.png')} style={[Styles.testImage,{width:'75%'}]} />
                <Text style={[Styles.testTextCenter]}>
                  Now let's test each microphone one by one to record sound, then listen to it,
                  if you can't hear anything tap the fail button on the right
                </Text>
                ...
                <View style={{width:'100%', display:'flex',paddingBottom:0,justifyContent:'center', flexDirection:'row', flexWrap:'wrap'}}>
                      ...
                      <TouchableOpacity
                        activeOpacity={.7}
                        style={[Styles.testFooterBtn,{marginHorizontal:5, backgroundColor:'#D22828'}]}
                      >
                        <Text style={[Styles.mainButtonText, {textTransform:'lowercase'}]}>Front</Text>
                      </TouchableOpacity>
                      ...
                      >
                        <Text style={[Styles.mainButtonText, {textTransform:'lowercase', marginHorizontal:5}]}>Back</Text>
                      </TouchableOpacity>
                      ...
                      <TouchableOpacity
                        ...
                        style={[Styles.testFooterBtn,{marginHorizontal:5}]}
                      >
                        <Text style={[Styles.mainButtonText, {textTransform:'lowercase'}]}>Under</Text>
                      </TouchableOpacity>

                </View>


                <Text style={[Styles.testTextCenter,{marginBottom:0,paddingBottom:0,textAlign:'left', fontSize:12, color:'grey', width:'100%',paddingLeft:10}]}>
                  Recording...
                </Text>
