    ...
    <SafeAreaView>
        ...
        <View style={{
          ...
          left:0,
            ...
            <Text style={[Styles.detailTitle,{textTransform:'none',fontSize:16}]}>Call Test</Text>
            <TouchableOpacity
                    activeOpacity={.7}
        ...
        <View style={{width:'100%',display:'flex', height:'100%',flexDirection:'column',justifyContent:'space-between', position: 'relative',}}>
          ...
          <View style={{width:'100%',paddingVertical:30, paddingHorizontal:30}}>
              ...
              <Text style={[Styles.testTextCenter]}>
                Please check if the device can make a call or not
              </Text>
              ...
              <TextInput
                ...
                />
                {/* <SimpleLineIcons name='screen-smartphone' color='#fff' size={100} style={{marginBottom:20}} /> */}
                {/* <AntDesign name='closecircle' color='#E16F6F' size={25} /> */}

                <TouchableOpacity style={[Styles.mainButton,{width:150,backgroundColor:'#2D81B8', marginTop:20,borderWidth:0, paddingVertical:10} ]}>
