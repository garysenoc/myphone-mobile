    ...
    <SafeAreaView>
      ...
      <ScrollView
        ...
        <View style={Styles.main}>
            ...
            <TouchableOpacity onPress={() => setTab([true, false, false])}>
              <Text
                style={[
                  Styles.genText,
                  {
                    fontWeight: tab[0] == true ? '700' : '600',
                    marginHorizontal: 10,
                    color: tab[0] == true ? '#070707' : '#B6B6B6',
                    paddingBottom: 8,
                    paddingHorizontal: 7,
                    borderBottomWidth: tab[0] == true ? 2 : 0,
                    borderBottomColor: '#3681B8',
                  },
                ]}>
                cart
              </Text>
            ...
            <TouchableOpacity onPress={() => setTab([false, true, false])}>
              <Text
                style={[
                  Styles.genText,
                  {
                    fontWeight: tab[1] == true ? '700' : '600',
                    marginHorizontal: 10,
                    color: tab[1] == true ? '#070707' : '#B6B6B6',
                    paddingBottom: 8,
                    paddingHorizontal: 7,
                    borderBottomWidth: tab[1] == true ? 2 : 0,
                    borderBottomColor: '#3681B8',
                  },
                ]}>
                checkout
            ...
            <TouchableOpacity onPress={() => setTab([false, false, true])}>
              <Text
                style={[
                  Styles.genText,
                  {
                    fontWeight: tab[2] == true ? '700' : '600',
                    marginHorizontal: 10,
                    color: tab[2] == true ? '#070707' : '#B6B6B6',
                    paddingBottom: 8,
                    paddingHorizontal: 7,
                    borderBottomWidth: tab[2] == true ? 2 : 0,
                    borderBottomColor: '#3681B8',
                  },
                ]}>
                confirmation
          ...
          {tab[0] == true && (
            <>
              <View
                ...
                <Text
                  style={[Styles.genText, {fontWeight: '600', width: '40%'}]}>
                  Product
                </Text>

                <Text
                  style={[Styles.genText, {fontWeight: '600', width: '20%'}]}>
                  Price
                </Text>
                <Text
                  style={[Styles.genText, {fontWeight: '600', width: '20%'}]}>
              ...
              <View
                ...
                <Text
                  style={[
                    Styles.genText,
                    {fontWeight: '600', fontSize: 14, width: '40%'},
                  ]}>
                  IPHONE 13 PRO MAX
                </Text>
                <Text
                  style={[
                    Styles.genText,
                    {fontWeight: '600', fontSize: 14, width: '20%'},
                  ]}>
                  310.00$
                </Text>
                <View
              ...
              <View
                ...
                <View
                  ...
                  <Text
                    style={[
                      Styles.cartText,
                      {fontSize: 14, marginRight: 50, color: '#070707'},
                    ]}>
                    Subtotal
                  </Text>
                  <Text
          ...
          {tab[1] == true && (
            <Checkout gotoConfirmation={() => setTab([false, false, true])} />
          )}
          {tab[2] == true && <Confirmation />}
