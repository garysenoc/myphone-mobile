        ...
        <View style={Styles.main}>
            ...
            <View style={{paddingVertical:20}}>
              ...
              <View style={Styles.detailList}>
                  ...
                  <View style={{backgroundColor:'#E7E7E9',marginBottom:10, width:'100%', padding:10,borderRadius:5}}>
                  ...
                  <View style={{backgroundColor:'#E7E7E9',marginBottom:10,width:'100%', padding:10,borderRadius:5}}>
                    ...
                    <TouchableOpacity
                      ...
                      style={[{width:'100%', marginVertical:10, paddingVertical:0, display:'flex', flexDirection:'row'} ]}
                    >
                  ...
                  <View style={{backgroundColor:'#E7E7E9',marginBottom:10,width:'100%', padding:10,borderRadius:5}}>
                    ...
                    <View style={{display:'flex', flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
                      ...
                      <Text style={{color:'#070707', fontSize:20, fontFamily:'Montserrat-SemiBold'}}> 
                        310.00$
                      </Text>
                    </View>
              ...
              <View>
                ...
                style={{ display:'flex',padding:.5,marginTop:16, borderRadius:5}}>
                </LinearGradient>
              </View>
